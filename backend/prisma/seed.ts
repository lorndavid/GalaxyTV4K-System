...
async function main() {
  ...
  await prisma.companySettings.upsert({
    ...
    create: {
      id: 'default',
      companyName: 'Apex Innovations Cambodia',
      companyLogo: null,
  ...
  const sampleEmployees = [
    ...
    },
    {
      ...
      firstName: 'Bopha',
      lastName: 'Heng',
      displayName: 'Bopha Heng',
      email: 'bopha.heng@company.com',
      phone: '+855 77 456 789',
      position: 'HR & People Operations Specialist',
    ...
    },
    {
      ...
      firstName: 'Chet',
      lastName: 'Meng',
      displayName: 'Chet Meng',
      email: 'chet.meng@company.com',
      phone: '+855 89 234 567',
    ...
    },
    {
      ...
      firstName: 'Sophal',
      lastName: 'Nuon',
      displayName: 'Sophal Nuon',
      email: 'sophal.nuon@company.com',
      phone: '+855 92 678 901',
